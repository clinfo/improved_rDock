...
extern bool b_receptor;
extern int counter_score_calculations;
extern int counter_mmgbpbsa_calculations;
...
#if 1 // AdvanceSoft (2018)
  void SetSink_rec(RbtMolecularFileSinkPtr);
  RbtMolecularFileSinkPtr GetSink_rec() const;
#endif // AdvanceSoft(2018)
...
#if 1 // AdvanceSoft (2018)
  RbtMolecularFileSinkPtr m_spSink_rec;
#endif // AdvanceSoft(2018)
