...
namespace Rbt
{
  ...
  //No1a
  //Is bond CA_C?
  class isBond_CA_C : public RbtBondUnaryPredicate {
  public:
	  explicit isBond_CA_C() {}
	  RbtBool operator() (RbtBond* pBond) const;
  };

  //No2a
  //Is bond C_C?
  class isBond_C_C : public RbtBondUnaryPredicate {
  public:
	  explicit isBond_C_C() {}
	  RbtBool operator() (RbtBond* pBond) const;
  };
  ...
  //No3a
  //Is bond C_S?
  class isBond_C_S : public RbtBondUnaryPredicate {
  public:
	  explicit isBond_C_S() {}
	  RbtBool operator() (RbtBond* pBond) const;
  };
  ...
  //No4a
  //Is bond C_OH?
  class isBond_C_OH : public RbtBondUnaryPredicate {
  public:
	  explicit isBond_C_OH() {}
	  RbtBool operator() (RbtBond* pBond) const;
  };

  //No5a
  //Is bond C_N?
  class isBond_C_N : public RbtBondUnaryPredicate {
  public:
	  explicit isBond_C_N() {}
	  RbtBool operator() (RbtBond* pBond) const;
  };
  ...
  //No6a
  //Is bond C_NH3?
  class isBond_C_NH3 : public RbtBondUnaryPredicate {
  public:
	  explicit isBond_C_NH3() {}
	  RbtBool operator() (RbtBond* pBond) const;
  };
