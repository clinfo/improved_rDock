...
class RbtMdlFileSink : public RbtBaseMolecularFileSink
{
 public:
  ...
  virtual void Render_rec() throw (RbtError);
#endif // AdvanceSoft(2018)
  
  
  
#if 1 // Xability (2017)
  virtual void SetModelAtc(RbtModelPtr sp) { m_spModelAtc = sp; }
#endif // Xability (2017)
...
#if 1 // AdvanceSoft (2018)
  void RenderAtomList_rec(const RbtAtomList& atomList);
#endif // AdvanceSoft(2018)
...
#if 1 // AdvanceSoft (2018)
  void RenderData_rec(const RbtStringVariantMap& dataMap);
#endif // AdvanceSoft(2018)
