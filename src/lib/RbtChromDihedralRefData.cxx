...
#if 1 // AdvanceSoft (2017)
	Rbt::Ad2ToSpin(spBond, atomList, bondList);
#endif // AdvanceSoft(2017)
...
#if 1 // AdvanceSoft (2017)
void RbtChromDihedralRefData::Ad2Setup(RbtBondPtr spBond,
	const RbtAtomList& tetheredAtoms)
{
	RbtAtom* pAtom2 = spBond->GetAtom1Ptr();
	RbtAtom* pAtom3 = spBond->GetAtom2Ptr();
