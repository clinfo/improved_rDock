...
RbtModelPtr RbtBaseMolecularFileSink::GetModel_lig() const
{
	return m_spModel_lig;
}
...
#if 1 // AdvanceSoft (2018)
void RbtBaseMolecularFileSink::SetModel_lig(RbtModelPtr spModel, RbtBool bUseModelSegmentNames)
{
	m_spModel_lig = spModel;
	m_bUseModelSegmentNames = bUseModelSegmentNames;
}
#endif // AdvanceSoft(2018)
