...
RbtString RbtNmrSF::_FILENAME_temp("FILENAME");
#else
...
#ifdef _VISUAL_STUDIO 
	AddParameter(_FILENAME_temp, RbtString("default.noe"));
#else
...
#ifdef _VISUAL_STUDIO 
  RbtString strRestrFile = Rbt::GetRbtFileName("data/receptors", GetParameter(_FILENAME_temp));
#else
