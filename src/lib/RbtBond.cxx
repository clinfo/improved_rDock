...
#if 1 // AdvanceSoft (2017)
//No1a
//Is bond CA_C?
RbtBool Rbt::isBond_CA_C::operator() (RbtBond* pBond) const {
	RbtAtomPtr spAtom1(pBond->GetAtom1Ptr());
	RbtAtomPtr spAtom2(pBond->GetAtom2Ptr());

	if ((spAtom1->GetAtomicNo() == 6) && (spAtom1->GetAtomName() == "CA")) {
		if ((spAtom2->GetAtomicNo() == 6) && (spAtom2->GetAtomName() != "C")) {

			return true;
		}
	}

	if ((spAtom2->GetAtomicNo() == 6) && (spAtom2->GetAtomName() == "CA")) {
		if ((spAtom1->GetAtomicNo() == 6) && (spAtom1->GetAtomName() != "C")) {
...
//No2a
//Is bond C_C?
RbtBool Rbt::isBond_C_C::operator() (RbtBond* pBond) const {
	RbtAtomPtr spAtom1(pBond->GetAtom1Ptr());
	RbtAtomPtr spAtom2(pBond->GetAtom2Ptr());

	if ((spAtom1->GetAtomicNo() == 6) && (spAtom1->GetAtomName() != "C") && (spAtom1->GetAtomName() != "CA")) {
		if ((spAtom2->GetAtomicNo() == 6) && (spAtom2->GetAtomName() != "C") && (spAtom2->GetAtomName() != "CA")) {
...
//No3a
//Is bond C_S?
RbtBool Rbt::isBond_C_S::operator() (RbtBond* pBond) const {
	RbtAtomPtr spAtom1(pBond->GetAtom1Ptr());
	RbtAtomPtr spAtom2(pBond->GetAtom2Ptr());

	if ((spAtom1->GetAtomicNo() == 6) && (spAtom1->GetAtomName() != "C")) {
		if (spAtom2->GetAtomicNo() == 16) {

			return true;
		}
	}

	if (spAtom1->GetAtomicNo() == 16) {
		if ((spAtom2->GetAtomicNo() == 6) && (spAtom2->GetAtomName() != "C")) {
...
//No4a
//Is bond C_OH?
RbtBool Rbt::isBond_C_OH::operator() (RbtBond* pBond) const {
	RbtAtomPtr spAtom1(pBond->GetAtom1Ptr());
	RbtAtomPtr spAtom2(pBond->GetAtom2Ptr());
	...
	if ((spAtom2->GetAtomicNo() == 8) && (spAtom2->GetNumImplicitHydrogens() + spAtom2->GetCoordinationNumber(1) == 1)) {
...
// No5a
//Is bond C_N?
RbtBool Rbt::isBond_C_N::operator() (RbtBond* pBond) const {
	RbtAtomPtr spAtom1(pBond->GetAtom1Ptr());
	RbtAtomPtr spAtom2(pBond->GetAtom2Ptr());

	if ((spAtom1->GetAtomicNo() == 6) && (spAtom1->GetAtomName() != "C") && (spAtom1->GetAtomName() != "CA")) {
		if ((spAtom2->GetAtomicNo() == 7) && (spAtom2->GetAtomName() != "N")) {
	...
	if ((spAtom2->GetAtomicNo() == 6) && (spAtom2->GetAtomName() != "C") && (spAtom2->GetAtomName() != "CA")) {
		if ((spAtom1->GetAtomicNo() == 7) && (spAtom1->GetAtomName() != "N")) {
...
// No6a
//Is bond C_NH3?
RbtBool Rbt::isBond_C_NH3::operator() (RbtBond* pBond) const {
	RbtAtomPtr spAtom1(pBond->GetAtom1Ptr());
	RbtAtomPtr spAtom2(pBond->GetAtom2Ptr());

	if ((spAtom1->GetAtomicNo() == 7) && (spAtom1->GetNumImplicitHydrogens() + spAtom1->GetCoordinationNumber(1) == 3) && (spAtom1->GetAtomName() == "N")) {

		return true;
	}

	if ((spAtom2->GetAtomicNo() == 7) && (spAtom2->GetNumImplicitHydrogens() + spAtom2->GetCoordinationNumber(1) == 3) && (spAtom2->GetAtomName() == "N")) {
