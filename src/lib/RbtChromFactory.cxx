...
bool b_side_chains_of_receptor(false);
...
void RbtChromFactory::VisitReceptorFlexData(RbtReceptorFlexData* pFlexData) {
	...
	if (pModel && pDockSite) {
		...
		Rbt::isBond_CA_C isCA_C; // No1a
		Rbt::isBond_C_C isC_C; // No2a
		Rbt::isBond_C_S isC_S; // No3a
		Rbt::isBond_C_OH isC_OH; // No4a
		Rbt::isBond_C_N isC_N; // No5a
		Rbt::isBond_C_NH3 isC_NH3; // No6a
...
#endif // AdvanceSoft(2018)
	}// the end of if (pModel && pDockSite)
}
