...
void RbtWorkSpace::SetSink_rec(RbtMolecularFileSinkPtr spSink) { m_spSink_rec = spSink; }
RbtMolecularFileSinkPtr RbtWorkSpace::GetSink_rec() const { return m_spSink_rec; }
